                ...
                ->action(function (): void {
                    try {
                        ...
                        Notification::make()
                            ...
                            ->body('A running server picks this up within a few seconds and downloads in the background, and this page shows each one arriving. A stopped server fetches them the next time it starts.')
                            ->success()
                            ->send();
                    } catch (Throwable $exception) {
                        report($exception);
